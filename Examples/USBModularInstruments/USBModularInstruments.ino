/*
 * Example sketch for the Keysight(Agilent) USB Modular Instruments - developed by Naoya Imai
 */
#include <usbhub.h>
...
#endif
    Serial.println(F("Keysight USB Modular Instruments"));
